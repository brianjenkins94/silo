...
test("exec: dangerous bin (rm) redline fail-closed", () => {
...
test("dynamic import() of node:fs is still intercepted", () => {
	const t = tmp("dyn.txt");
...
test("eval is redline fail-closed", () => {
